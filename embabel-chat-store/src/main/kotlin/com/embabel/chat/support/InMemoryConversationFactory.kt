...
/**
 * Factory for creating [InMemoryStorableConversation] instances.
 *
 * Messages are stored in memory and not persisted.
 * Optionally wraps conversations with [EventPublishingConversation] for event publishing.
 *
...
class InMemoryConversationFactory(
    ...
    override fun create(id: String): Conversation {
        val conversation = InMemoryStorableConversation(id = id)
