...
class StoredConversation(
    ...
    // Keep the original message (including assets) visible until the async write completes;
    // MessageData only carries the fields persisted on the message node.
    ...
    // Keep asset-free messages on the existing repository path so older implementations
    // do not need to implement the new asset-aware method.
